 ...
 * @author gregsh
 */
@SuppressWarnings({"StringEquality", "StaticMethodOnlyUsedInOneClass", "LocalVariableOfConcreteClass", "MethodParameterOfConcreteClass", "TypeMayBeWeakened", "UnusedDeclaration"})
public class GeneratedParserUtilBase
{
    ...
    public interface Parser extends com.intellij.lang.parser.GeneratedParserUtilBase.Parser
    {
    ...
    public static boolean empty_element_parsed_guard_(PsiBuilder builder_, int offset_, String funcName_)
    {
    ...
    public static boolean nextTokenIs(PsiBuilder builder_, String s, IElementType key, IElementType token)
    {
    ...
    public static boolean consumeTokenInner(PsiBuilder builder_, CharSequence text, boolean caseSensitive)
    {
                                                    ...
                                                    @Nullable Parser eatMore)
    {
        ...
        if (sectionType == _SECTION_RECOVER_ && !state.suppressErrors && eatMore != null) {
            ...
            while (eatMoreFlag && builder_.getCurrentOffset() < lastErrorPos) {
                if (state.braces != null) {
                    if (builder_.getTokenType() == state.braces[0].getLeftBraceType())
                        parenCount++;
                    else if (builder_.getTokenType() == state.braces[0].getRightBraceType())
                        parenCount--;
                }
                builder_.advanceLexer();
            ...
            if (errorReported) {
                ...
                builder_.advanceLexer();
                final String gotText = expectedText.isEmpty() ? "'" + tokenText + "' unexpected" : "got '" + tokenText + "'";
            ...
            if (!result && eatMoreFlagOnce && frame.offset != builder_.getCurrentOffset())
                result = true;
    ...
    public static class CompletionState implements Function<Object, String>
    {
        ...
        public CompletionState(int completionOffset)
        {
            this.offset = completionOffset;
        }
    ...
    @SuppressWarnings({"InstanceVariableOfConcreteClass", "ParameterHidesMemberVariable"})
    ...
    @SuppressWarnings({"InstanceVariableOfConcreteClass", "MethodReturnOfConcreteClass", "CastToConcreteClass", "PublicMethodNotExposedInInterface"})
    public static class ErrorState
    {
        ...
        final LimitedPool<Variant> VARIANTS = new LimitedPool<Variant>(CAPACITY, new LimitedPool.ObjectFactory<Variant>()
        {
        ...
        public String getExpectedText(PsiBuilder builder_)
        {
            ...
            if (addExpected(sb, offset, true)) {
                sb.append(" expected, ");
            } else if (addExpected(sb, offset, false))
        ...
        private boolean addExpected(StringBuilder sb, int offset, boolean expected)
        {
            ...
            int count = 0;
            loop:
            for (Variant variant : expected ? variants : unexpected) {
    ...
    @SuppressWarnings({"MethodReturnOfConcreteClass", "PublicMethodNotExposedInInterface", "ParameterHidesMemberVariable"})
    ...
    public static class Variant
    {
        ...
        public boolean equals(Object o)
        {
            ...
            return offset == variant.offset && this.object.equals(variant.object);
        }
    ...
    public static boolean parseAsTree(ErrorState state, final PsiBuilder builder_, int level, final IElementType chunkType,
                                      boolean checkBraces, final com.intellij.lang.parser.GeneratedParserUtilBase.Parser parser, final com.intellij.lang.parser.GeneratedParserUtilBase.Parser eatMoreCondition)
    {
