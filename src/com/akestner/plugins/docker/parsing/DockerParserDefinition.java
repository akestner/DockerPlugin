...
import com.akestner.plugins.docker.psi.DockerPsiFile;
...
public class DockerParserDefinition implements ParserDefinition
{
    ...
    public static final TokenSet COMMENT = TokenSet.create(DockerTypes.COMMENT_LINE);
    ...
    public static final TokenSet INSTRUCTION = TokenSet.create(DockerTypes.INSTRUCTION_LINE);
    public static final TokenSet WHITE_SPACE = TokenSet.create(TokenType.WHITE_SPACE);
    public static final TokenSet LINE_ENDING = TokenSet.create(DockerTypes.LINE_TERMINATION);
    ...
    {
        return new DockerPsiFile(viewProvider);
    }
